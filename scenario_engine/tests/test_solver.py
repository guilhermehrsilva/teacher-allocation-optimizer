...
class SolverTests(unittest.TestCase):
    ...
    def test_scenario_internalization_prefers_internal_teacher(self):
        ...
        self.assertEqual(internal.id, result.assignments[0].teacher_id)
        self.assertEqual(1, result.diagnostics["scenario_internal_assignments"])
    ...
    def test_scenario_cluster_recovers_offer_with_controlled_profile_override(self):
        ...
        result = solve_allocation(
            ...
            scenario_policy={"policies": [{
                ...
                "target_value": "GESTÃO", "configuration": {},
            }]},
        )
        self.assertEqual(0, result.assignments[0].teacher_id)
        ...
        self.assertEqual("APROVADO", audit_allocation(problem, result).status)
